...
make_rootfs_tarball()
{
    ...
    mmdebstrap --architectures=riscv64 \
        ...
        sid $1 \
        "deb https://fast-mirror.isrc.ac.cn/revyos/revyos-gles-21/ revyos-gles-21 main" \
        "deb https://fast-mirror.isrc.ac.cn/revyos/revyos-addons/ revyos-addons main" \
        "deb https://fast-mirror.isrc.ac.cn/revyos/revyos-kernels/ revyos-kernels main" \
        "deb https://fast-mirror.isrc.ac.cn/revyos/revyos-base/ sid main contrib non-free non-free-firmware"
}
